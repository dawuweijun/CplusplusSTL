//Test Program for finding the index in which table contain the data
//and also for testing the linearinterpolating
//
//$ID: miliu, Wed Aug 14 10:55:38 CST 2013 exp$
//
